...
function App() {
  ...
  function removeTask(id: string, todolistId: string) {
    setTodo(todo.map(tl => tl.id === todolistId ? {...tl, tasks: tl.tasks.filter(t => t.taskId !== id)} : tl))
  }
  function addTask(title: string, todolistId: string) {
    setTodo(todo.map(tl => tl.id === todolistId ? {...tl, tasks: [...tl.tasks, {taskId: v1(), title, isDone: false}]} : tl))
  }
  ...
  function changeFilter(filter: FilterValuesType, todolistId: string) {
    setTodo(todo.map(tl => tl.id === todolistId ? {...tl, filter} : tl))
  }
